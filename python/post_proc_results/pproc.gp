...
plot [1000:] 'ratio2.txt' title "nsamp / nprob, convert to sparse array", "ratio_no_Counts.txt" title "nsamp / nprob no conversion", "ratio_dict.txt" title "nsamp / nprob convert to dict"
